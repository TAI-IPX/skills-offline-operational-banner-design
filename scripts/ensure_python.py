...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"[OK] Found Python: {python_exe}")
        ...
        if check_python_version():
            print("[OK] Python version meets requirement (3.8+)")
        else:
            print(f"[WARN] Python version too low: {sys.version_info.major}.{sys.version_info.minor}")
